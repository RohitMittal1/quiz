...
// When the "Start Quiz" button is clicked, it shows the info_box by adding a new class activeInfo to it, which makes it visible on the page.
start_btn.onclick = ()=>{
    info_box.classList.add("activeInfo"); //show info box
}

// if exitQuiz button clicked
// f the "Exit Quiz" button inside the info_box is clicked, the info_box is hidden by removing the activeInfo class.
exit_btn.onclick = ()=>{
